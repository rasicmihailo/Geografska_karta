...

{
    public class TackastiObjekatMapiranje : SubclassMap<TackastiObjekat>
    {
        ...
        public TackastiObjekatMapiranje()
        {
            ...
            //HasMany(x => x.Lista_Znamenitosti).KeyColumn("ID_NASELJENOG_MESTA").Cascade.All().Inverse().LazyLoad();
            ...
            //HasMany(x => x.Lista_SadrziTac).KeyColumn("ID1").Cascade.All().Inverse().LazyLoad();
        }
