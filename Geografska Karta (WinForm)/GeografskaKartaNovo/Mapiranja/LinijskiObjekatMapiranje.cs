...
namespace GeografskaKartaNovo.Mapiranja
{
    public class LinijskiObjekatMapiranje : SubclassMap<LinijskiObjekat>
    {
        public LinijskiObjekatMapiranje()
        {
            ...
            HasMany(x => x.ListaKoordinata).KeyColumn("ID_LINIJSKOG_OBJEKTA").Cascade.All().Inverse().Not.LazyLoad();
            ...
            HasMany(x => x.Lista_SadrziTac).KeyColumn("ID0").Cascade.All().Inverse().Not.LazyLoad();
            ...
            HasMany(x => x.Lista_SadrziLin).KeyColumn("ID1").Cascade.All().Inverse().Not.LazyLoad();
