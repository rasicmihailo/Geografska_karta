...
namespace GeografskaKartaNovo.Mapiranja
{
    public class PovrsinskiObjekatMapiranje : SubclassMap<PovrsinskiObjekat>
    {
        public PovrsinskiObjekatMapiranje()
        {
            ...
            HasMany(x => x.Lista_SadrziLin).KeyColumn("ID0").Cascade.All().Inverse().Not.LazyLoad();
    ...
    public class UzvisenjeMapiranje : SubclassMap<Uzvisenje>
    {
        public UzvisenjeMapiranje()
        {
            ...
            HasMany(x => x.Lista_Vrhova).KeyColumn("ID_UZVISENJA").Cascade.All().Inverse().Not.LazyLoad();
            ...
            HasMany(x => x.Lista_SadrziGeog).KeyColumn("ID0").Cascade.All().Inverse().Not.LazyLoad();
        }
